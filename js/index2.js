...
function guardarCarritoEnLocalStorage() {
    // Obtener los elementos del carrito y guardar los datos relevantes
...
function enviarCarritoAPHP() {
    ...
    xhr.open('POST','../proyecto2.0/js/index2.php', true);
    xhr.setRequestHeader('Content-Type', 'application/json');

    xhr.send(JSON.stringify({ carritoItems: items }));
